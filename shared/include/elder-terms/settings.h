...
/**
 * Binding used when Enter or Return produces an ordinary line ending.
 */
enum class TerminalReturnCode {
  /** Preserve the line-ending sequence generated by VTE. */
  automatic,
  /** ASCII carriage return (0x0d). */
  cr,
  /** ASCII line feed (0x0a). */
  lf,
  /** ASCII carriage return followed by line feed. */
  crlf,
};
...
struct TerminalTextSettings {
  ...
  /** Binding used by Enter and Return keys. */
...
/**
 * Returns the INI value for an Enter/Return binding.
 *
 * @param code Enter/Return binding.
 * @returns Stable setting value.
 */
ELDER_TERMS_API const char *
terminal_return_code_to_string(TerminalReturnCode code);
